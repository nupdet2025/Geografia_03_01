...
gdjs.Cena_9506Code.GDcard_959501Objects1= [];
gdjs.Cena_9506Code.GDcard_959501Objects2= [];
gdjs.Cena_9506Code.GDcard_959501Objects3= [];
gdjs.Cena_9506Code.GDgarotoObjects1= [];
gdjs.Cena_9506Code.GDgarotoObjects2= [];
gdjs.Cena_9506Code.GDgarotoObjects3= [];
...
gdjs.Cena_9506Code.asyncCallback13915324 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9506Code.asyncCallback13915324(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9506Code.asyncCallback13917204 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9506Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9506Code.asyncCallback13917204(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9506Code.asyncCallback13920324 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9506Code.localVariables);
...
gdjs.copyArray(asyncObjectsList.getObjects("card_01"), gdjs.Cena_9506Code.GDcard_959501Objects3);
...
for(var i = 0, len = gdjs.Cena_9506Code.GDcard_959501Objects3.length ;i < len;++i) {
    gdjs.Cena_9506Code.GDcard_959501Objects3[i].deleteFromScene(runtimeScene);
}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.Cena_9506Code.asyncCallback13920324(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9506Code.asyncCallback13919940 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9506Code.localVariables);
...
for (const obj of gdjs.Cena_9506Code.GDbtn_9595errado_959501Objects1) asyncObjectsList.addObject("btn_errado_01", obj);
for (const obj of gdjs.Cena_9506Code.GDbtn_9595errado_959502Objects1) asyncObjectsList.addObject("btn_errado_02", obj);
for (const obj of gdjs.Cena_9506Code.GDcard_959501Objects1) asyncObjectsList.addObject("card_01", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Cena_9506Code.asyncCallback13919940(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.copyArray(runtimeScene.getObjects("btn_errado_01"), gdjs.Cena_9506Code.GDbtn_9595errado_959501Objects1);
gdjs.copyArray(runtimeScene.getObjects("btn_errado_02"), gdjs.Cena_9506Code.GDbtn_9595errado_959502Objects1);
gdjs.copyArray(runtimeScene.getObjects("card_01"), gdjs.Cena_9506Code.GDcard_959501Objects1);
...
for (var i = 0, k = 0, l = gdjs.Cena_9506Code.GDcard_959501Objects1.length;i<l;++i) {
    if ( gdjs.Cena_9506Code.GDcard_959501Objects1[i].isVisible() ) {
        isConditionTrue_0 = true;
        gdjs.Cena_9506Code.GDcard_959501Objects1[k] = gdjs.Cena_9506Code.GDcard_959501Objects1[i];
        ++k;
    }
}
gdjs.Cena_9506Code.GDcard_959501Objects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Cena_9506Code.GDbtn_9595errado_959501Objects1.length;i<l;++i) {
...
gdjs.Cena_9506Code.GDcard_959501Objects1.length = 0;
gdjs.Cena_9506Code.GDcard_959501Objects2.length = 0;
gdjs.Cena_9506Code.GDcard_959501Objects3.length = 0;
gdjs.Cena_9506Code.GDgarotoObjects1.length = 0;
gdjs.Cena_9506Code.GDgarotoObjects2.length = 0;
gdjs.Cena_9506Code.GDgarotoObjects3.length = 0;
